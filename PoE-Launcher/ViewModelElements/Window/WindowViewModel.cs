...
namespace PoE_Launcher
{
    ...
    public class WindowViewModel : BaseViewModel
    {
        ...
        /// </summary>
        public bool IsBorderless { get { return (mWindow.WindowState == WindowState.Maximized || mDockPosition != WindowDockPosition.Undocked); } }

        /// <summary>
        /// The size of the resize border around the window
        /// </summary>
        public int ResizeBorder { get { return IsBorderless ? 0 : 6; } }
        ...
        public int OuterMarginSize
        {
            get
            {
                ...
                return IsBorderless ? 0 : mOuterMarginSize;
            }
            set
            {
        ...
        public int WindowRadius
        {
            ...
            {
                // Return nothing if window is borderless to fill whole screen
                return IsBorderless ? 0 : mWindowRadius;
            }
            set
            {
                mWindowRadius = value;
        ...
        public WindowViewModel(Window window)
        {
            ...
            this.mWindow.SizeChanged += (sender, e) =>
            {
